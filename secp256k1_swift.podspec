...
s.source           = { :git => 'https://github.com/bankex/secp256k1_swift.git', :tag => s.version.to_s, :submodules => true }
...
s.source_files = 'Classes/secp256k1/{src,include,contrib}/*.{h,c}', 'Classes/secp256k1/src/modules/{recovery,ecdh}/*.{h,c}', 'Classes/libsecp256k1-config.h', 'secp256k1/Classes/secp256k1_main.h', 'secp256k1.swift'
